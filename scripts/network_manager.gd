...
const PLAYER_SCENE := preload("res://scenes/characters/mplayer.tscn")
...
func _on_player_connected(id: int):
	...
	if current_scene.scene_file_path == "res://scenes/world/game_area.tscn":
		waiting_spectators[id] = true
		_dbg("Peer " + str(id) + " joined mid-round. Marked as waiting spectator")
		change_scene.rpc_id(id, "res://scenes/world/game_area.tscn")
		return

	if current_scene.scene_file_path != "res://scenes/world/game_area.tscn" and current_scene.scene_file_path != "res://scenes/core/main.tscn":
...
func request_lobby_spawn():
	...
	var current_scene := get_tree().current_scene
	if current_scene == null or current_scene.scene_file_path != "res://scenes/core/main.tscn":
...
func _on_player_disconnected(id: int):
	...
	if id == 1:
		...
		if get_tree().current_scene != null and get_tree().current_scene.scene_file_path != "res://scenes/core/main.tscn":
...
func _return_everyone_to_lobby():
	...
	_change_scene_for_all("res://scenes/core/main.tscn")
...
func start_match_from_lobby():
	...
	_change_scene_for_all("res://scenes/world/game_area.tscn")
...
func _apply_pending_scene_change():
	...
	used_spawn_points.clear()
	ready_clients.clear()
	if path == "res://scenes/core/main.tscn":
